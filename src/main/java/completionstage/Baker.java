...
public class Baker {
    ...
    public CompletionStage<SlicedBread> orderSlicedBreadComplex() {
        ...
        CompletionStage<Dough> dough = flourOrder.thenApply(
                new Function<Flour, Dough>() {
        ...
        CompletionStage<Bread> bread = dough.thenCompose(
                new Function<Dough, CompletionStage<Bread>>() {
                    @Override
        ...
        CompletionStage<SlicedBread> slicedBreadOrder = bread.thenApply(
                new Function<Bread, SlicedBread>() {
                    @Override
    ...
    /**
     * Order some sliced bread from the baker, guaranteeing that it will be delivered,
     * even when the Miller has no flour
     *
     * @return The sliced bread
     */
    ...
    /**
     * Order some sliced bread from the baker, guaranteeing that it will be
     * delivered, with both fresh flour and fresh
     * yeast.
     *
     * @return The sliced bread
     */
